...
# Form implementation generated from reading ui file 'C:\Users\94890\Desktop\YTfiles\Myfiles\Myfiles\files\double_confidence_interval.ui'
#
...
class Ui_double_confidence_interval_Form(object):
    def setupUi(self, double_confidence_interval_Form):
        ...
        self.pushButton.setGeometry(QtCore.QRect(250, 90, 161, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.pushButton.setFont(font)
        self.pushButton.setObjectName("pushButton")
        self.widget = Plot(double_confidence_interval_Form)
        self.widget.setGeometry(QtCore.QRect(450, 100, 641, 551))
        ...
        self.pushButton_7.setGeometry(QtCore.QRect(310, 30, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.pushButton_7.setFont(font)
        self.pushButton_7.setObjectName("pushButton_7")
        self.radioButton = QtWidgets.QRadioButton(double_confidence_interval_Form)
        self.radioButton.setGeometry(QtCore.QRect(460, 30, 201, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.doubleSpinBox_5 = QtWidgets.QDoubleSpinBox(self.layoutWidget2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.doubleSpinBox_4 = QtWidgets.QDoubleSpinBox(self.layoutWidget2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, double_confidence_interval_Form):
        ...
        self.pushButton.setText(_translate("double_confidence_interval_Form", "计算置信区间"))
